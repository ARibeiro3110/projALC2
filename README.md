...
This git repository belongs to group 20 and is intended for project2 of alc24.
...
The result of the project evaluation using this set of holdout tests will be available in the [README](https://gitlab.rnl.tecnico.ulisboa.pt/alc24/feedback/project2/20/-/tree/master/README.md) of the feedback repository after each code submission.
